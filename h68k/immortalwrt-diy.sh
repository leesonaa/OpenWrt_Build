...
sed -i '/exit 0/d' package/emortal/default-settings/files/99-default-settings-chinese
cat << EOF >> package/emortal/default-settings/files/99-default-settings-chinese
